    ...
    public partial class InterviewList
    {
        ...
        */
		...
		public static void Test()
		{
            ...
            //var temp = obj.BuildTree(new int[] { 1, 2, 4,  3, 6, 7 }, new int[] { 4, 2,  1, 6, 3, 7 });

            //var temp = obj.LadderLength("hit", "cog", new List<string> { "hot", "dot", "dog", "lot", "log", "cog" });

			
            Console.Write(temp);

			//var temp = obj.NumDecodings("7541387519572282368613553811323167125532172369624572591562685959575371877973171856836975137559677665");
			//var temp = obj.NumDecodings("201220");

			//var temp = obj.Exist(new char[,]
			//{
			//    {'C','A','A'}, 
			//    {'A','A','A'},            
			//    {'B','C','D'}, 
